<%@page import="org.ruyue.basic.model.SystemContent"%>
<%@ page import="org.ruyue.basic.model.SystemContent" %>
...
<pg:pager export="curPage=pageNumber" 
	...
	maxPageItems="<%=SystemContent.getPageSize() %>"
	url="${param.url }">
	<span style="float:right;padding:6px;">
	共
	<pg:last>
		${pageNumber } 页[${param.totalRecord }条记录],每页显示<%=SystemContent.getPageSize() %>条,
	</pg:last>
